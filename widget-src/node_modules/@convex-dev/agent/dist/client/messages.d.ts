 ...
 */
export declare function saveMessages(ctx: MutationCtx, component: AgentComponent, args: SaveMessagesArgs & {
    /**
 ...
 */
export declare function saveMessage(ctx: MutationCtx, component: AgentComponent, args: SaveMessageArgs & {
    /**
